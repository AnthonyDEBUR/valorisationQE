                               ...
                               con)
{
  ...
  sous_titre<-ifelse(nrow(pluie[pluie$source!="donnée interpolée",])>0,
                     "données Météo-France (open data)",
                     "interpolation par Eaux & Vilaine des données Météo-France")
...
# Calcul du percentile au sens de la DCE
```{r function-percentile_dce}
...
# Percentile DCE par station et CdParametre

```{r function-percentile_dce_par_station_multi}
...
```{r examples-percentile_dce_par_station_multi}
...
```{r tests-percentile_dce_par_station_multi}
