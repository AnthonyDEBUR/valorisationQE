...
#' Dans le tableau "Oui" signifie que la substance est autorisée sur la culture,
#' "Non" signifie que la substance a été autorisée mais est désormais interdite,
#' "Variant" signifie que la substance n'est aps autorisée sur la culture mais 
#' qu'un de ses variants l'est (ex. Diméthénamide-P autorisé et mesuré avec
#' le Diméthénamide total alors que ce dernier n'est plus autorisé).
#'
#' @export
...
```{r example-fiche_usages_pesticides, fig.width=10}
ref_pestibase <- importe_ref_pestibase()
